...
const itemsDB = {
  ...
  I00A: { id: 'I00A', name: 'Щит', icon: '', type: 'basic', cost: 600, description: '+4 защиты' },
  I00D: { id: 'I00D', name: 'Шлем', icon: '', type: 'basic', cost: 450, description: '+3 защиты' },
  ...
  I0CQ: { id: 'I0CQ', name: 'Меч доблести', icon: '', type: 'basic', cost: 3300, description: '+110 атаки' },
  ...
  desc: { id: 'desc', name: 'Кинжал мага', icon: '', type: 'basic', cost: 2100,
    description: 'Скачок (актив) (700)',
    activeAbility: { name: 'Скачок', description: 'Беспрепятственное перемещение на короткую дистанцию', cooldown: 25, manacost: 200, note: null } },
  ajen: { id: 'ajen', name: 'Чаша выносливости', icon: '', type: 'basic', cost: 700, description: 'Аура скорости (5% AS, 10% MS)' },
  evtl: { id: 'evtl', name: 'Талисман защиты', icon: '', type: 'basic', cost: 2000, description: '+10% уклонение' },
  ...
  I0C9: { id: 'I0C9', name: 'Солнечный камень', icon: '', type: 'basic', cost: 1400,
  ...
  // ---------- БРОНЯ И ДОСПЕХИ ----------
  I002: { id: 'I002', name: 'Щит древних', icon: '', type: 'basic_shield', cost: 2900,
  ...
  I00S: { id: 'I00S', name: 'Щит смерти', icon: '', type: 'basic_shield', cost: 10550,
  ...
  I09T: { id: 'I09T', name: 'Рыцарский щит', icon: '', type: 'basic_shield', cost: 15750,
  ...
  I0D0: { id: 'I0D0', name: 'Рыцарский шлем', icon: '', type: 'basic', cost: 2550,
  ...
  I036: { id: 'I036', name: 'Шлем из кожи дракона', icon: '', type: 'basic', cost: 7900,
  ...
  I02Y: { id: 'I02Y', name: 'Кираса из кожи дракона', icon: '', type: 'basic', cost: 13125,
  ...
  I045: { id: 'I045', name: 'Доспехи дракона', icon: '', type: 'strength', cost: 46025,
  ...
  I02B: { id: 'I02B', name: 'Доспехи полководца', icon: '', type: 'strength', cost: 16500,
  ...
  I0AF: { id: 'I0AF', name: 'Антимагические доспехи', icon: '', type: 'magic_immune', cost: 47975,
  ...
  I0GN: { id: 'I0GN', name: 'Шлем штормового рыцаря', icon: '', type: 'strength', cost: 8450,
  ...
  I0DU: { id: 'I0DU', name: 'Кираса шторма', icon: '', type: 'strength', cost: 16300,
  ...
  I0GO: { id: 'I0GO', name: 'Доспехи штормового стража', icon: '', type: 'strength', cost: 87525,
  ...
  // ---------- ВООРУЖЕНИЕ ----------
  I034: { id: 'I034', name: 'Призрачный клинок I', icon: '', type: 'weapon', cost: 8800,
  ...
  I035: { id: 'I035', name: 'Призрачный клинок II', icon: '', type: 'weapon', cost: 12800,
  ...
  I03J: { id: 'I03J', name: 'Меч чёрной магии', icon: '', type: 'weapon', cost: 59400, tags: ['boss', 'unique'],
  ...
  I0GJ: { id: 'I0GJ', name: 'Клеймор', icon: '', type: 'weapon', cost: 45775,
  ...
  I00Y: { id: 'I00Y', name: 'Огненный меч', icon: '', type: 'weapon', cost: 3400,
  ...
  I0AO: { id: 'I0AO', name: 'Светлый меч', icon: '', type: 'weapon', cost: 8100,
  ...
  I0E5: { id: 'I0E5', name: 'Меч очищения', icon: '', type: 'weapon', cost: 29050,
  ...
  I0FO: { id: 'I0FO', name: 'Клинок солнца', icon: '️', type: 'weapon', cost: 3850,
  ...
  I0FQ: { id: 'I0FQ', name: 'Скрещенные клинки', icon: '', type: 'weapon', cost: 18400,
  ...
  I08Y: { id: 'I08Y', name: 'Посох грома', icon: '', type: 'intelligence', cost: 30900,
  ...
  I02T: { id: 'I02T', name: 'Ледяной меч I', icon: '', type: 'intelligence', cost: 4325,
  ...
  I00U: { id: 'I00U', name: 'Ледяной меч II', icon: '', type: 'intelligence', cost: 6525,
  ...
  I02U: { id: 'I02U', name: 'Ледяной меч III', icon: '', type: 'intelligence', cost: 8725,
  ...
  I03E: { id: 'I03E', name: 'Ледяной меч IV', icon: '', type: 'intelligence', cost: 10925,
  ...
  I03F: { id: 'I03F', name: 'Ледяной меч V', icon: '', type: 'intelligence', cost: 13125,
  ...
  I02Z: { id: 'I02Z', name: 'Ледяное око', icon: '', type: 'intelligence', cost: 6400,
  ...
  I01I: { id: 'I01I', name: 'Ледяные доспехи', icon: '️', type: 'intelligence', cost: 10225,
  ...
  I09R: { id: 'I09R', name: 'Ледяной дух', icon: '', type: 'intelligence', cost: 43750,
  ...
  I026: { id: 'I026', name: 'Сердце демона', icon: '', type: 'magic_vampirism_block', cost: 29450,
  ...
  I043: { id: 'I043', name: 'Сердце демона II', icon: '', type: 'magic_vampirism_block', cost: 42950,
  ...
  I0BV: { id: 'I0BV', name: 'Демоническая сущность', icon: '', type: 'magic_vampirism_block', cost: 56450, tags: ['boss', 'unique'],
  ...
  I0DT: { id: 'I0DT', name: 'Крест', icon: '', type: 'neutral', cost: 4550,
  ...
  I0CN: { id: 'I0CN', name: 'Сфера магии', icon: '', type: 'rare', cost: 17850, tags: ['boss', 'unique'],
  ...
  I028: { id: 'I028', name: 'Посох разложения I', icon: '', type: 'magic_immune', cost: 8525,
  ...
  I08U: { id: 'I08U', name: 'Посох разложения II', icon: '', type: 'magic_immune', cost: 15025,
  ...
  I0DA: { id: 'I0DA', name: 'Алебарда', icon: '', type: 'strength_control', cost: 13250,
  ...
  I08W: { id: 'I08W', name: 'Клинок ведьмака II', icon: '', type: 'intelligence', cost: 12725,
  ...
  I08X: { id: 'I08X', name: 'Клинок ведьмака III', icon: '', type: 'intelligence', cost: 23975,
  ...
  I01B: { id: 'I01B', name: 'Клинок убийцы', icon: '', type: 'agility', cost: 28575,
  ...
  I0EO: { id: 'I0EO', name: 'Нефритовые клинки', icon: '', type: 'agility', cost: 38600,
  ...
  I01J: { id: 'I01J', name: 'Ледяной элемент', icon: '', type: 'rare', cost: 60000, tags: ['boss'],
    description: '+500 ко всем атрибутам',
    components: [ {itemId: 'I02E', quantity: 1}, {itemId: 'recipe', quantity: 1, costOverride: 20000} ]
  },
  I03L: { id: 'I03L', name: 'Меч вечной стужи', icon: '️', type: 'weapon_intelligence', cost: 203750, tags: ['boss', 'unique'],
  ...
  I02D: { id: 'I02D', name: 'Щит джаггернаута', icon: '', type: 'armor', cost: 87050, tags: ['boss', 'unique'],
  ...
  I0A5: { id: 'I0A5', name: 'Нерубский доспех', icon: '️', type: 'armor', cost: 80000, tags: ['boss'],
  ...
  I0B6: { id: 'I0B6', name: 'Щит джаггернаута II', icon: '', type: 'armor', cost: 267050, tags: ['boss', 'unique'],
  ...
  I01L: { id: 'I01L', name: 'Доспехи великана', icon: '', type: 'boss_drop', cost: 30000, description: '+50 защиты, возврат урона 20% (пассив). Падает при смерти!' },
  I0B5: { id: 'I0B5', name: 'Душа призрака', icon: '', type: 'boss_drop', cost: 5000, description: '+50 ко всем атрибутам. Падает при смерти!' },
  I047: { id: 'I047', name: 'Рапира', icon: '', type: 'boss_drop', cost: 50000, description: '+1500 атаки. Падает при смерти!' },
  ...
  I04W: { id: 'I04W', name: 'Книга Познания', icon: '', type: 'boost', cost: 0, costCrystals: 12, description: '+1 уровень' },
  I057: { id: 'I057', name: 'Книга Могущества', icon: '', type: 'boost', cost: 0, costCrystals: 60, description: '+5 уровней' },
...
/* Классы предметов (itemLevel в JASS) — нельзя носить два предмета одного класса.
   Число = класс, строка = название для сайта.
   Заполни числа и названия по мере готовности. */
...
function renderItemTypeBadges(item) {
  ...
  if (!uniqueLabels.length && !item.itemClass) return '';
  // Бейдж класса предмета (если задан)
  const classLabel = item.itemClass && ITEM_CLASS_NAMES[item.itemClass]
    ? '<span class="detail-badge badge-class" title="Нельзя носить два предмета одного класса">Класс: ' + ITEM_CLASS_NAMES[item.itemClass] + '</span>'
    : '';
  return '<div class="detail-badges">' + uniqueLabels.map(label => {
    const isUnique = label === '1 на героя';
    return '<span class="detail-badge' + (item.type === 'boss_drop' ? ' badge-danger' : '') + (isUnique ? ' badge-unique' : '') + '"' + (isUnique ? ' title="Нельзя носить больше одного предмета данного типа"' : '') + '>' + label + '</span>';
  }).join('') + classLabel + '</div>';
}
