...
var HEROES_DATA = [
    ...
    { name: 'Адмирал', title: 'Морской воин', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'admiral', image: 'admiral', charName: 'Прохор',
      rawcode: 'H03J',
    ...
    { name: 'Друид', title: 'Хранитель природы', attr: 'strength', roles: ['support'], roleNames: ['Помощник'], heroId: 'druid', image: 'druid', charName: 'Сильвестр',
      rawcode: 'E001',
    ...
    { name: 'Киборг', title: 'Механический воин', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'cyborg', image: 'cyborg', charName: 'Алекс',
      rawcode: 'H000',
    ...
    { name: 'Паладин', title: 'Святой рыцарь', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'paladin', image: 'paladin', charName: 'Светозар',
      rawcode: 'H00H',
    ...
    { name: 'Астральный Палач', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'astral-executioner', image: 'astral-executioner', charName: 'Геннадий',
      rawcode: 'E011',
    ...
    { name: 'Костолом', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'bonebreaker', image: 'bonebreaker', charName: '',
      rawcode: 'H01U',
    ...
    { name: 'Огненный Рыцарь', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'fire-knight', image: 'fire-knight', charName: '',
      rawcode: 'H02A',
    ...
    { name: 'Воин Глубин', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'deep-warrior', image: 'deep-warrior', charName: '',
      rawcode: 'H07A',
    ...
    { name: 'Разрушитель', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'destroyer', image: 'destroyer', charName: '',
      rawcode: 'N00I',
    ...
    { name: 'Всадник', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'rider', image: 'rider', charName: '',
      rawcode: 'O003',
    ...
    { name: 'Вождь Минотавров', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'minotaur-chief', image: 'minotaur-chief', charName: '',
      rawcode: 'O006',
    ...
    { name: 'Вождь Орков', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'orc-chieftain', image: 'orc-chieftain', charName: '',
      rawcode: 'O00A',
    ...
    { name: 'Титан', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'titan', image: 'titan', charName: '',
      rawcode: 'O00B',
    ...
    { name: 'Вурдалак', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'vurdalak', image: 'vurdalak', charName: '',
      rawcode: 'O00D',
    ...
    { name: 'Мясник', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'butcher', image: 'butcher', charName: '',
      rawcode: 'U001',
    ...
    { name: 'Огненный Голем', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'fire-golem-hero', image: 'fire-golem-hero', charName: '',
      rawcode: 'U007',
    ...
    { name: 'Король Проклятых', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'king-of-cursed', image: 'king-of-cursed', charName: '',
      rawcode: 'U009',
      strBase: 25, strGain: 3, agiBase: 15, agiGain: 2, intBase: 20, intGain: 2,
      hp: 650, mp: 200, atk: 20, def: 0, atkSpeed: 2, hpRegen: 0, mpRegen: 0.01, speed: 320, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Лорд Хаоса', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'chaos-lord', image: 'chaos-lord', charName: '',
      rawcode: 'U00A',
    ...
    { name: 'Повелитель Могил', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'grave-lord', image: 'grave-lord', charName: '',
      unique: true,
      rawcode: 'U01J',
      strBase: 30, strGain: 3, agiBase: 14, agiGain: 2, intBase: 16, intGain: 2,
      hp: 600, mp: 150, atk: 30, def: 2, atkSpeed: 2, hpRegen: 0, mpRegen: 0.01, speed: 290, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Ледяной Рыцарь', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'ice-knight', image: 'ice-knight', charName: '',
      rawcode: 'U01T',
      strBase: 26, strGain: 3, agiBase: 18, agiGain: 2, intBase: 18, intGain: 2,
      hp: 650, mp: 200, atk: 20, def: 0, atkSpeed: 2, hpRegen: 0, mpRegen: 0.01, speed: 320, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Хаотическая Форма', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'chaos-lord-chaos', image: 'chaos-lord-chaos', charName: '',
      isAltForm: true,
      rawcode: 'H088',
    ...
    { name: 'Привратник Ада', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'hell-gatekeeper', image: 'hell-gatekeeper', charName: '',
      unique: true,
      isAltForm: true,
      rawcode: 'H08A',
      strBase: 30, strGain: 3, agiBase: 15, agiGain: 2, intBase: 15, intGain: 2,
    ...
    { name: 'Костолом', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'bonebreaker-alt', image: 'bonebreaker-alt', charName: '',
      isAltForm: true,
      rawcode: 'H099',
    ...
    { name: 'Всадник', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'rider-mounted', image: 'rider-mounted', charName: '',
      isAltForm: true,
      rawcode: 'O004',
    ...
    { name: 'Гнев Титана', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'titan-enraged', image: 'titan-enraged', charName: '',
      isAltForm: true,
      rawcode: 'O00C',
    ...
    { name: 'Лорд Хаоса', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'chaos-lord-alt', image: 'chaos-lord-alt', charName: '',
      isAltForm: true,
      rawcode: 'U00B',
    ...
    { name: 'Пивовар', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'brewmaster', image: 'brewmaster', charName: '',
      rawcode: 'N002',
    ...
    { name: 'Чародей', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'sorcerer', image: 'sorcerer', charName: '',
      rawcode: 'H011',
    ...
    { name: 'Астральный Маг', title: '', attr: 'strength', roles: ['support'], roleNames: ['Помощник'], heroId: 'astral-mage', image: 'astral-mage', charName: '',
      unique: true,
      rawcode: 'H055',
    ...
    { name: 'Демон', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'demon', image: 'demon', charName: '',
      unique: true,
      rawcode: 'O00M',
    ...
    { name: 'Пожиратель Пламени', title: '', attr: 'strength', roles: ['support'], roleNames: ['Помощник'], heroId: 'flame-eater', image: 'flame-eater', charName: '',
      unique: true,
      rawcode: 'H08O',
    ...
    { name: 'Темный Мастер', title: '', attr: 'strength', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-master', image: 'dark-master', charName: '',
      unique: true,
      rawcode: 'H07E',
    ...
    { name: 'Иллюзионист', title: 'Мастер обмана', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'illusionist', image: 'illusionist', charName: 'Алексей',
      rawcode: 'E000',
    ...
    { name: 'Мурлок', title: 'Подводный охотник', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'murloc', image: 'murloc', charName: '',
      rawcode: 'E004',
    ...
    { name: 'Темная Лучница', title: 'Ледяная охотница', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'dark-archer', image: 'dark-archer', charName: '',
      rawcode: 'E00O',
    ...
    { name: 'Воительница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'warrioress', image: 'warrioress', charName: '',
      rawcode: 'E00H',
    ...
    { name: 'Жрица Луны', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'priestess', image: 'priestess', charName: '',
      rawcode: 'E010',
    ...
    { name: 'Стражница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'guardian', image: 'guardian', charName: '',
      rawcode: 'E020',
      strBase: 21, strGain: 2, agiBase: 24, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 0, atk: 40, def: 2, atkSpeed: 1.7, hpRegen: 0, mpRegen: 0.01, speed: 310, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Зодиак', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'zodiac', image: 'zodiac', charName: '',
      unique: true,
      rawcode: 'E02O',
    ...
    { name: 'Ночной Хищник', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'night-predator', image: 'night-predator', charName: '',
      rawcode: 'E03S',
    ...
    { name: 'Егерь', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'ranger', image: 'ranger', charName: '',
      rawcode: 'H001',
    ...
    { name: 'Тень', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'shadow', image: 'shadow', charName: '',
      rawcode: 'H037',
      strBase: 20, strGain: 2, agiBase: 25, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 150, atk: 55, def: 1, atkSpeed: 1.7, hpRegen: 1, mpRegen: 0.01, speed: 295, range: 700, sightDay: 1800, sightNight: 800 },

    { name: 'Десантник', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'marine', image: 'marine', charName: '',
      rawcode: 'H03H',
    ...
    { name: 'Покорительница Молний', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'lightning-subjugator', image: 'lightning-subjugator', charName: '',
      rawcode: 'H046',
    ...
    { name: 'Отец Тьмы', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'father-of-darkness', image: 'father-of-darkness', charName: '',
      unique: true,
      rawcode: 'H089',
    ...
    { name: 'Темный Рыцарь', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'dark-knight', image: 'dark-knight', charName: '',
      rawcode: 'H09N',
      strBase: 20, strGain: 2, agiBase: 26, agiGain: 3, intBase: 14, intGain: 2,
      hp: 200, mp: 150, atk: 70, def: 0, atkSpeed: 1.7, hpRegen: 0.5, mpRegen: 0.01, speed: 320, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Астральная Охотница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'astral-huntress', image: 'astral-huntress', charName: '',
      rawcode: 'H0AG',
      strBase: 17, strGain: 2, agiBase: 27, agiGain: 3, intBase: 16, intGain: 2,
      hp: 200, mp: 150, atk: 45, def: 0, atkSpeed: 1.7, hpRegen: 0, mpRegen: 0.01, speed: 290, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Пламенный Берсеркер', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'flame-berserker', image: 'flame-berserker', charName: '',
      rawcode: 'O008',
    ...
    { name: 'Грозовой Рыцарь', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'storm-knight', image: 'storm-knight', charName: '',
      rawcode: 'O00F',
      strBase: 21, strGain: 2, agiBase: 24, agiGain: 3, intBase: 15, intGain: 2,
      hp: 250, mp: 150, atk: 40, def: 0, atkSpeed: 1.7, hpRegen: 2, mpRegen: 0.01, speed: 310, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Водяной', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'water-spirit', image: 'water-spirit', charName: '',
      rawcode: 'O00L',
    ...
    { name: 'Вампир', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'vampire', image: 'vampire', charName: '',
      unique: true,
      rawcode: 'U006',
    ...
    { name: 'Демоническая Форма', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'illusionist-demon', image: 'illusionist-demon', charName: '',
      isAltForm: true,
      rawcode: 'E002',
    ...
    { name: 'Пламенный Берсеркер', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'flame-berserker-alt', image: 'flame-berserker-alt', charName: '',
      isAltForm: true,
      rawcode: 'O009',
    ...
    { name: 'Самурай', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'samurai', image: 'samurai', charName: '',
      rawcode: 'O000',
      strBase: 15, strGain: 2, agiBase: 30, agiGain: 3, intBase: 15, intGain: 2,
    ...
    { name: 'Призрак', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'ghost', image: 'ghost', charName: '',
      rawcode: 'O002',
    ...
    { name: 'Морской Страж', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'sea-guard', image: 'sea-guard', charName: '',
      rawcode: 'O005',
      strBase: 20, strGain: 2, agiBase: 26, agiGain: 3, intBase: 14, intGain: 2,
      hp: 200, mp: 150, atk: 45, def: 1, atkSpeed: 1.7, hpRegen: 1, mpRegen: 0.01, speed: 280, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Звездный Дух', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'star-spirit', image: 'star-spirit', charName: '',
      rawcode: 'O00K',
    ...
    { name: 'Ночная Мстительница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'night-avenger', image: 'night-avenger', charName: '',
      rawcode: 'O00O',
      strBase: 15, strGain: 2, agiBase: 30, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 150, atk: 50, def: 0, atkSpeed: 1.7, hpRegen: 1, mpRegen: 0, speed: 0, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Скелет', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'skeleton', image: 'skeleton', charName: '',
      unique: true,
      rawcode: 'O00E',
    ...
    { name: 'Мятежник', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'rebel', image: 'rebel', charName: '',
      unique: true,
      rawcode: 'O00P',
    ...
    { name: 'Ассасин', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'assassin', image: 'assassin', charName: '',
      unique: true,
      rawcode: 'O010',
      strBase: 20, strGain: 2, agiBase: 25, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 150, atk: 50, def: 1, atkSpeed: 1.7, hpRegen: 0.5, mpRegen: 0, speed: 310, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Огненная Панда', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'fire-panda', image: 'fire-panda', charName: '',
      unique: true,
      rawcode: 'O011',
      strBase: 10, strGain: 2, agiBase: 40, agiGain: 3, intBase: 10, intGain: 2,
      hp: 200, mp: 150, atk: 50, def: 1, atkSpeed: 1.7, hpRegen: 0.5, mpRegen: 0, speed: 0, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Блудсасир', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'bloodsucker', image: 'bloodsucker', charName: '',
      wip: true,
      rawcode: 'H095',
    ...
    { name: 'Громовержец', title: 'Повелитель молний', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'thundergod', image: 'thundergod', charName: 'Василий',
      rawcode: 'O001',
    ...
    { name: 'Верховный Маг', title: 'Маг воды', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'archmage', image: 'Archmage', charName: '',
      rawcode: 'H02P',
    ...
    { name: 'Леший', title: 'Друид', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'leshy', image: 'leshy', charName: '',
      rawcode: 'E006',
    ...
    { name: 'Некромонгер', title: 'Повелитель мёртвых', attr: 'intelligence', roles: ['support'], roleNames: ['Поддержка'], heroId: 'necromonger', image: 'necromonger', charName: '',
      rawcode: 'H06G',
    ...
    { name: 'Дух Природы', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'spirit-of-nature', image: 'spirit-of-nature', charName: '',
      isAltForm: true,
      rawcode: 'E03H',
      strBase: 20, strGain: 2, agiBase: 18, agiGain: 2, intBase: 22, intGain: 3,
      hp: 1250, mp: 150, atk: 20, def: 1, atkSpeed: 2.25, hpRegen: 51, mpRegen: 0, speed: 0, range: 750, sightDay: 800, sightNight: 800 },

    { name: 'Воин Света', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'warrior-of-light', image: 'warrior-of-light', charName: '',
      rawcode: 'H00F',
    ...
    { name: 'Повелитель Тьмы', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-lord', image: 'dark-lord', charName: '',
      rawcode: 'H00V',
    ...
    { name: 'Темный Маг', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-mage', image: 'dark-mage', charName: '',
      rawcode: 'H02F',
    ...
    { name: 'Волшебница Ветров', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'wind-enchantress', image: 'wind-enchantress', charName: '',
      rawcode: 'H02G',
    ...
    { name: 'Маг Воздуха', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'air-mage', image: 'air-mage', charName: '',
      rawcode: 'H04E',
    ...
    { name: 'Ведьмак Хаоса', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'chaos-witcher', image: 'chaos-witcher', charName: '',
      unique: true,
      rawcode: 'H08T',
    ...
    { name: 'Шторм', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'storm', image: 'storm', charName: '',
      rawcode: 'N00E',
      strBase: 15, strGain: 2, agiBase: 15, agiGain: 2, intBase: 30, intGain: 3,
      hp: 200, mp: 150, atk: 30, def: 0, atkSpeed: 2.25, hpRegen: 1, mpRegen: 0, speed: 320, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Рыцарь Глубин', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'knight-of-depths', image: 'knight-of-depths', charName: '',
      rawcode: 'O00G',
    ...
    { name: 'Гидралиск', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'hydralisk', image: 'hydralisk', charName: '',
      unique: true,
      rawcode: 'O00N',
    ...
    { name: 'Повелитель Льдов', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'frost-lord', image: 'frost-lord', charName: '',
      rawcode: 'U000',
    ...
    { name: 'Повелитель Огня', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'fire-lord', image: 'fire-lord', charName: '',
      rawcode: 'N005',
      strBase: 16, strGain: 2, agiBase: 17, agiGain: 2, intBase: 27, intGain: 3,
      hp: 200, mp: 150, atk: 20, def: 1, atkSpeed: 2.25, hpRegen: 0, mpRegen: 0, speed: 305, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Повелитель Вихрей', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'wind-lord', image: 'wind-lord', charName: '',
      rawcode: 'O007',
    ...
    { name: 'Владыка Молний', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'lightning-lord', image: 'lightning-lord', charName: '',
      rawcode: 'O00H',
    ...
    { name: 'Темный Шаман', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-shaman', image: 'dark-shaman', charName: '',
      rawcode: 'O00I',
    ...
    { name: 'Снежная Королева', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'snow-queen', image: 'snow-queen', charName: '',
      rawcode: 'O00J',
      strBase: 15, strGain: 2, agiBase: 15, agiGain: 2, intBase: 30, intGain: 3,
