...
var HEROES_DATA = [
    ...
    { name: 'Костолом', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'bonebreaker', image: 'bonebreaker', charName: 'Иннокентий',
      rawcode: 'H01U',
    ...
    { name: 'Огненный Рыцарь', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'fire-knight', image: 'fire-knight', charName: 'Мстислав',
      rawcode: 'H02A',
    ...
    { name: 'Воин Глубин', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'deep-warrior', image: 'deep-warrior', charName: 'Тихон',
      rawcode: 'H07A',
    ...
    { name: 'Разрушитель', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'destroyer', image: 'destroyer', charName: 'Кузьма',
      rawcode: 'N00I',
    ...
    { name: 'Всадник', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'rider', image: 'rider', charName: 'Ромео',
      rawcode: 'O003',
    ...
    { name: 'Вождь Минотавров', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'minotaur-chief', image: 'minotaur-chief', charName: 'Марк',
      rawcode: 'O006',
    ...
    { name: 'Вождь Орков', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'orc-chieftain', image: 'orc-chieftain', charName: 'Федор',
      rawcode: 'O00A',
    ...
    { name: 'Титан', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'titan', image: 'titan', charName: 'Андрей',
      rawcode: 'O00B',
    ...
    { name: 'Вурдалак', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'vurdalak', image: 'vurdalak', charName: 'Вадик',
      rawcode: 'O00D',
    ...
    { name: 'Мясник', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'butcher', image: 'butcher', charName: 'Энди',
      rawcode: 'U001',
    ...
    { name: 'Огненный Голем', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'fire-golem-hero', image: 'fire-golem-hero', charName: 'Джек',
      rawcode: 'U007',
    ...
    { name: 'Король Проклятых', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'king-of-cursed', image: 'king-of-cursed', charName: 'Сергей',
      rawcode: 'U009',
      strBase: 25, strGain: 3, agiBase: 15, agiGain: 2, intBase: 20, intGain: 2,
      hp: 650, mp: 200, atk: 20, def: 0, atkSpeed: 2, hpRegen: 0, mpRegen: 0.01, speed: 320, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Лорд Хаоса', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'chaos-lord', image: 'chaos-lord', charName: 'Даркдарон',
      rawcode: 'U00A',
    ...
    { name: 'Повелитель Могил', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'grave-lord', image: 'grave-lord', charName: 'Рикардо',
      unique: true,
      rawcode: 'U01J',
      strBase: 30, strGain: 3, agiBase: 14, agiGain: 2, intBase: 16, intGain: 2,
      hp: 600, mp: 150, atk: 30, def: 2, atkSpeed: 2, hpRegen: 0, mpRegen: 0.01, speed: 290, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Ледяной Рыцарь', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'ice-knight', image: 'ice-knight', charName: 'Маркус',
      rawcode: 'U01T',
    ...
    { name: 'Пивовар', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'brewmaster', image: 'brewmaster', charName: 'Артур',
      rawcode: 'N002',
    ...
    { name: 'Чародей', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'sorcerer', image: 'sorcerer', charName: 'Кайл',
      rawcode: 'H011',
    ...
    { name: 'Астральный Маг', title: '', attr: 'strength', roles: ['support'], roleNames: ['Помощник'], heroId: 'astral-mage', image: 'astral-mage', charName: 'Марина',
      unique: true,
      rawcode: 'H055',
    ...
    { name: 'Демон', title: '', attr: 'strength', roles: ['tank'], roleNames: ['Танк'], heroId: 'demon', image: 'demon', charName: 'Игорь',
      unique: true,
      rawcode: 'O00M',
    ...
    { name: 'Пожиратель Пламени', title: '', attr: 'strength', roles: ['support'], roleNames: ['Помощник'], heroId: 'flame-eater', image: 'flame-eater', charName: 'Феликс',
      unique: true,
      rawcode: 'H08O',
    ...
    { name: 'Темный Мастер', title: '', attr: 'strength', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-master', image: 'dark-master', charName: 'Леонардо',
      unique: true,
      rawcode: 'H07E',
    ...
    { name: 'Мурлок', title: 'Подводный охотник', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'murloc', image: 'murloc', charName: 'Пьер',
      rawcode: 'E004',
    ...
    { name: 'Темная Лучница', title: 'Ледяная охотница', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'dark-archer', image: 'dark-archer', charName: 'Алёна',
      rawcode: 'E00O',
    ...
    { name: 'Воительница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'warrioress', image: 'warrioress', charName: 'Лианна',
      rawcode: 'E00H',
    ...
    { name: 'Жрица Луны', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'priestess', image: 'priestess', charName: 'Эльвира',
      rawcode: 'E010',
    ...
    { name: 'Стражница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'guardian', image: 'guardian', charName: 'Кристина',
      rawcode: 'E020',
      strBase: 21, strGain: 2, agiBase: 24, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 0, atk: 40, def: 2, atkSpeed: 1.7, hpRegen: 0, mpRegen: 0.01, speed: 310, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Зодиак', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'zodiac', image: 'zodiac', charName: 'Глеб',
      unique: true,
      rawcode: 'E02O',
    ...
    { name: 'Ночной Хищник', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'night-predator', image: 'night-predator', charName: 'Лапа',
      rawcode: 'E03S',
    ...
    { name: 'Егерь', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'ranger', image: 'ranger', charName: 'Елена',
      rawcode: 'H001',
    ...
    { name: 'Тень', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'shadow', image: 'shadow', charName: 'Наполеон',
      rawcode: 'H037',
      strBase: 20, strGain: 2, agiBase: 25, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 150, atk: 55, def: 1, atkSpeed: 1.7, hpRegen: 1, mpRegen: 0.01, speed: 295, range: 700, sightDay: 1800, sightNight: 800 },

    { name: 'Десантник', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'marine', image: 'marine', charName: 'Константин',
      rawcode: 'H03H',
    ...
    { name: 'Покорительница Молний', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'lightning-subjugator', image: 'lightning-subjugator', charName: 'Екатерина',
      rawcode: 'H046',
    ...
    { name: 'Отец Тьмы', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'father-of-darkness', image: 'father-of-darkness', charName: 'Злыдень',
      unique: true,
      rawcode: 'H089',
    ...
    { name: 'Темный Рыцарь', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'dark-knight', image: 'dark-knight', charName: 'Максим',
      rawcode: 'H09N',
      strBase: 20, strGain: 2, agiBase: 26, agiGain: 3, intBase: 14, intGain: 2,
      hp: 200, mp: 150, atk: 70, def: 0, atkSpeed: 1.7, hpRegen: 0.5, mpRegen: 0.01, speed: 320, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Астральная Охотница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'astral-huntress', image: 'astral-huntress', charName: 'Мия',
      rawcode: 'H0AG',
      strBase: 17, strGain: 2, agiBase: 27, agiGain: 3, intBase: 16, intGain: 2,
      hp: 200, mp: 150, atk: 45, def: 0, atkSpeed: 1.7, hpRegen: 0, mpRegen: 0.01, speed: 290, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Пламенный Берсеркер', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'flame-berserker', image: 'flame-berserker', charName: 'Даниил',
      rawcode: 'O008',
    ...
    { name: 'Грозовой Рыцарь', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'storm-knight', image: 'storm-knight', charName: 'Дарио',
      rawcode: 'O00F',
      strBase: 21, strGain: 2, agiBase: 24, agiGain: 3, intBase: 15, intGain: 2,
      hp: 250, mp: 150, atk: 40, def: 0, atkSpeed: 1.7, hpRegen: 2, mpRegen: 0.01, speed: 310, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Водяной', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'water-spirit', image: 'water-spirit', charName: 'Анатолий',
      rawcode: 'O00L',
    ...
    { name: 'Вампир', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'vampire', image: 'vampire', charName: 'Влад',
      unique: true,
      rawcode: 'U006',
    ...
    { name: 'Самурай', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'samurai', image: 'samurai', charName: 'Евгений',
      rawcode: 'O000',
      strBase: 15, strGain: 2, agiBase: 30, agiGain: 3, intBase: 15, intGain: 2,
    ...
    { name: 'Призрак', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'ghost', image: 'ghost', charName: 'Моморо',
      rawcode: 'O002',
    ...
    { name: 'Морской Страж', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'sea-guard', image: 'sea-guard', charName: 'Гоша',
      rawcode: 'O005',
      strBase: 20, strGain: 2, agiBase: 26, agiGain: 3, intBase: 14, intGain: 2,
      hp: 200, mp: 150, atk: 45, def: 1, atkSpeed: 1.7, hpRegen: 1, mpRegen: 0.01, speed: 280, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Звездный Дух', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'star-spirit', image: 'star-spirit', charName: 'Ульяна',
      rawcode: 'O00K',
    ...
    { name: 'Ночная Мстительница', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'night-avenger', image: 'night-avenger', charName: 'Славянка',
      rawcode: 'O00O',
      strBase: 15, strGain: 2, agiBase: 30, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 150, atk: 50, def: 0, atkSpeed: 1.7, hpRegen: 1, mpRegen: 0, speed: 0, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Скелет', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'skeleton', image: 'skeleton', charName: 'Андриан',
      unique: true,
      rawcode: 'O00E',
    ...
    { name: 'Мятежник', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'rebel', image: 'rebel', charName: 'Цицерон',
      unique: true,
      rawcode: 'O00P',
    ...
    { name: 'Ассасин', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'assassin', image: 'assassin', charName: 'Яна',
      unique: true,
      rawcode: 'O010',
      strBase: 20, strGain: 2, agiBase: 25, agiGain: 3, intBase: 15, intGain: 2,
      hp: 200, mp: 150, atk: 50, def: 1, atkSpeed: 1.7, hpRegen: 0.5, mpRegen: 0, speed: 310, range: 150, sightDay: 1800, sightNight: 800 },

    { name: 'Огненная Панда', title: '', attr: 'agility', roles: ['damager'], roleNames: ['Дамагер'], heroId: 'fire-panda', image: 'fire-panda', charName: 'Ксин',
      unique: true,
      rawcode: 'O011',
    ...
    { name: 'Верховный Маг', title: 'Маг воды', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'archmage', image: 'Archmage', charName: 'Павел',
      rawcode: 'H02P',
    ...
    { name: 'Леший', title: 'Друид', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'leshy', image: 'leshy', charName: 'Адам',
      rawcode: 'E006',
    ...
    { name: 'Некромонгер', title: 'Повелитель мёртвых', attr: 'intelligence', roles: ['support'], roleNames: ['Поддержка'], heroId: 'necromonger', image: 'necromonger', charName: 'Дармонт',
      rawcode: 'H06G',
    ...
    { name: 'Воин Света', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'warrior-of-light', image: 'warrior-of-light', charName: 'Дмитрий',
      rawcode: 'H00F',
    ...
    { name: 'Повелитель Тьмы', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-lord', image: 'dark-lord', charName: 'Багратион',
      rawcode: 'H00V',
    ...
    { name: 'Темный Маг', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-mage', image: 'dark-mage', charName: 'Августин',
      rawcode: 'H02F',
    ...
    { name: 'Волшебница Ветров', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'wind-enchantress', image: 'wind-enchantress', charName: 'Виктория',
      rawcode: 'H02G',
    ...
    { name: 'Маг Воздуха', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'air-mage', image: 'air-mage', charName: 'Олег',
      rawcode: 'H04E',
    ...
    { name: 'Ведьмак Хаоса', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'chaos-witcher', image: 'chaos-witcher', charName: 'Игнат',
      unique: true,
      rawcode: 'H08T',
    ...
    { name: 'Шторм', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'storm', image: 'storm', charName: 'Николай',
      rawcode: 'N00E',
      strBase: 15, strGain: 2, agiBase: 15, agiGain: 2, intBase: 30, intGain: 3,
      hp: 200, mp: 150, atk: 30, def: 0, atkSpeed: 2.25, hpRegen: 1, mpRegen: 0, speed: 320, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Рыцарь Глубин', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'knight-of-depths', image: 'knight-of-depths', charName: 'Денис',
      rawcode: 'O00G',
    ...
    { name: 'Гидралиск', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'hydralisk', image: 'hydralisk', charName: 'Харитон',
      unique: true,
      rawcode: 'O00N',
    ...
    { name: 'Повелитель Льдов', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'frost-lord', image: 'frost-lord', charName: 'Борис',
      rawcode: 'U000',
    ...
    { name: 'Повелитель Огня', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'fire-lord', image: 'fire-lord', charName: 'Михаил',
      rawcode: 'N005',
      strBase: 16, strGain: 2, agiBase: 17, agiGain: 2, intBase: 27, intGain: 3,
      hp: 200, mp: 150, atk: 20, def: 1, atkSpeed: 2.25, hpRegen: 0, mpRegen: 0, speed: 305, range: 600, sightDay: 1800, sightNight: 800 },

    { name: 'Повелитель Вихрей', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'wind-lord', image: 'wind-lord', charName: 'Григорий',
      rawcode: 'O007',
    ...
    { name: 'Владыка Молний', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'lightning-lord', image: 'lightning-lord', charName: 'Альберт',
      rawcode: 'O00H',
    ...
    { name: 'Темный Шаман', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'dark-shaman', image: 'dark-shaman', charName: 'Августин',
      rawcode: 'O00I',
    ...
    { name: 'Снежная Королева', title: '', attr: 'intelligence', roles: ['support'], roleNames: ['Помощник'], heroId: 'snow-queen', image: 'snow-queen', charName: 'Светлана',
      rawcode: 'O00J',
      strBase: 15, strGain: 2, agiBase: 15, agiGain: 2, intBase: 30, intGain: 3,
